...
define(["angular","./app.controllers"],function(angular,controllers){
    ...
    controllers.controller("setMenuCtrl",["$rootScope","$scope","$location","menuData","dataMenuService",function($rootScope,$scope,$location,menuData,dataMenuService){
        ...
        self.setPlan=function(plan){
            ...
            if(typeof self.menuFilter.project !=="undefined"){
                ...
                $location.path("/set/"+projectCd+"/"+planId);
            }
