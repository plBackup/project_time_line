        ...
        var service = {
            getData: function (search,cb) {
              ...
              /* return $http.get($rootScope.plink+'/sdk!node.action'+search, {cache: false,'Content-Type':'application/x-www-form-urlencoded',withCredentials:true}).then(function (res) {
                ...
                return $http.get($rootScope.plink+'/sdk!organization.action'+search, {cache: false,'Content-Type':'application/x-www-form-urlencoded',withCredentials:true}).then(function(res){
                    if(typeof cb!=="undefined"){
                        cb(res.data);
                    }else{
                        return res.data;
